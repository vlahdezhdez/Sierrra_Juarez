...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11882442.583296, 3688347.265474, -11827697.080315, 3735707.678215],
            units: 'm'
        })
    })
});
...
map.getView().fit([-11873250.818307, 3696917.353890, -11798894.586445, 3737721.423910], map.getSize());
